...
Scripts oficiales para crear nuevos proyectos basados en el template **Furnarius** (`mmanto/furnarius`), con soporte para Desarrollo Basado en Arquitectura + Asistencia por IA.
